...
namespace PikachuMusicRun.Localization
{
    ...
    /// </summary>
    public class PMR_TextManager : PMR_SingletonMonobehaviour<PMR_TextManager>
    {
        #region Variables
        ...
        /// </summary>
        private Dictionary<string, Dictionary<string, PMR_TextItem>> m_texts;
        /// <summary>
        ...
        {
            Dictionary<string, PMR_TextItem> m_vTempDictionary = new Dictionary<string, PMR_TextItem>();
            ...
            foreach (XmlNode TableNode in globalTable)
            {
                ...
                if (newItemContext != "")
                {
                    ...
                    {
                        PMR_TextItem newInfoText = null;
                        //(string _key, string _text, string _audioName, bool _hasOptions, bool _showOptions)  
                        newInfoText = new PMR_TextItem(newItemContext, TableNode.ChildNodes[1].InnerText);
